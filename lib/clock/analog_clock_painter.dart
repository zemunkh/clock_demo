...
class AnalogClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _paintCircle(canvas, size, scaleFactor);
  }
  ...
  _paintCircle(canvas, size, scaleFactor) {
    ...
    canvas.drawCircle(size.center(Offset.zero),
      BASE_SIZE/2 * scaleFactor, midPointStrokePainter);
  }
  ...
  void _drawIndicators(Canvas canvas, Size size, double scaleFactor) {
    TextStyle style = TextStyle(
        ...
        fontSize: 32.0 * scaleFactor * textScaleFactor);
    double p = 4.0;
    if (showTicks) p += 24.0;
  ...
  void _drawAllIndicators(Canvas canvas, Size size, double scaleFactor) {
    ...
    Offset paddingY_7 = Offset(-(scaleFactor * 60), (p * scaleFactor * 8.7));
    Offset paddingX_8 = Offset(-(p * scaleFactor * 3.8), scaleFactor * 200);
